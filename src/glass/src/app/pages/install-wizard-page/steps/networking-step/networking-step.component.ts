...
@Component({
  selector: 'glass-networking-step',
  templateUrl: './networking-step.component.html',
  styleUrls: ['./networking-step.component.scss']
})
export class NetworkingStepComponent implements OnInit, OnDestroy {
  @Input()
