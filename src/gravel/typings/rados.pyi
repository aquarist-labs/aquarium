...
class Rados:
    ...
    def mon_command(self, cmd: str, inbuf: bytes, timeout: int = ...,
                    target: Optional[Union[str, int]] = ...
    ) -> Tuple[int, bytes, str]: ...
    def osd_command(self, osdid: int, cmd: str,
                    inbuf: bytes, timeout: int = ...
    ) -> Tuple[int, bytes, str]: ...
    def mgr_command(self, cmd: str, inbuf: bytes,
                    timeout: int = ..., target: Optional[str] = ...
    ) -> Tuple[int, bytes, str]: ...
    def pg_command(self, pgid: str, cmd: str,
                   inbuf: bytes, timeout: int = ...
    ) -> Tuple[int, bytes, str]: ...
    def wait_for_latest_osdmap(self) -> int: ...
    def blocklist_add(self, client_address: str,
                      expire_seconds: int = ...
    ) -> None: ...
    def monitor_log(self, level: str,
                    callback: Optional[Callable[[object, str, str, str, int, int, int, str, str], None]] = ...,
                    arg: Optional[object] = ...
    ) -> None: ...
    def monitor_log2(self, level: str,
                     callback: Optional[Callable[[object, str, str, str, str, int, int, int, str, str], None]],
                     arg: Optional[object] = ...
    ) -> None: ...
