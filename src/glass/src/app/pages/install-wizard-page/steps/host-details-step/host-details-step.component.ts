...
@Component({
  selector: 'glass-host-details-step',
  templateUrl: './host-details-step.component.html',
  styleUrls: ['./host-details-step.component.scss']
})
export class HostDetailsStepComponent implements OnInit, OnDestroy {
  @Input()
    ...
    fields: [
      {
        ...
        value: '',
        required: true,
        hint: TEXT('The name of the node.')
      }
    ]
  };
  ...
  get completed(): boolean {
    return this.form?.formGroup ? this.form.formGroup.valid : false;
  }
